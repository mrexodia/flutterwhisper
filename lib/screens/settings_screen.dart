...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _apiEndpointController = TextEditingController(text: widget.settings.apiEndpoint);
    _selectedLanguage = widget.settings.langCode;
    _suppressNonSpeech = widget.settings.suppressNonSpeech;
    _hotkeyComboController = TextEditingController(text: widget.settings.hotkeyCombo);
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: WhisperSettings.supportedLanguages.entries.map((entry) {
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      helperText: 'Format: Modifier+Modifier+Key (e.g. Control+Alt+L)',
                      border: const OutlineInputBorder(),
                    ),
                    onChanged: (_) {
                      // Clear error when user types
